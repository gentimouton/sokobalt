# window module - convenience methods for pygame.display - CC0
# slightly adapted from https://github.com/cosmologicon/pygame-window

from __future__ import division
import pygame, math, os.path, datetime

WINDOW_FLAGS = 0
FULLSCREEN_FLAGS = 0 #pygame.HWSURFACE | pygame.DOUBLEBUF # use SW surf only
...
def set_mode(size0 = None, height = (), fullscreen = None, forceres = None):
